...
class TestPlace(unittest.TestCase):
    ...
    def test_city_id_attr(self):
        """verify if Place has attr city_id, and it's an empty string"""
        place = Place()
        self.assertTrue(hasattr(place, "city_id"))
        self.assertEqual(place.city_id, "")

    def test_user_id_attr(self):
        """check if Place has attr user_id, and it's an empty string"""
        place = Place()
    ...
    def test_description_attr(self):
        """check if Place has attr description, and it's an empty string"""
        place = Place()
    ...
    def test_max_guest_attr(self):
        """verify Place has attr max_guest, and it's an int == 0"""
        place = Place()
    ...
    def test_price_by_night_attr(self):
        """check Place has attr price_by_night, and it's an int == 0"""
        place = Place()
    ...
    def test_latitude_attr(self):
        """verify Place has attr latitude, and it's a float == 0.0"""
        place = Place()
