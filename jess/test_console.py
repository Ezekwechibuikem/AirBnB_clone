#!/usr/bin/python3
"""
Storage class for the unit testing
"""
import unittest
import json
import pep8
...
class TestConsoleClass(unittest.TestCase):
   """TestConsoleClass for unit testing the console module"""

    maxDiff = None

    def setUp(self):
        """ test file saving and conditions """
        with open("test.json", 'w'):
            FileStorage._FileStorage__file_path = "test.json"
            FileStorage._FileStorage__objects = {}

    def tearDown(self):
        """ pull down the file storage """
    ...
    def test_pep8(self):
        """ pep8 conformance for test base and test_base  """
    ...
    def test_create_empty(self):
        """ verification of the create function """
        with patch('sys.stdout', new=StringIO()) as help_val:
    ...
    def test_show(self):
        """ normal parameters for test case """
        with patch('sys.stdout', new=StringIO()) as val:
            HBNBCommand().onecmd('create BaseModel')
    ...
    def test_show_empty(self):
        """ checks and Testing with class missing """
        with patch('sys.stdout', new=StringIO()) as val:
    ...
    def test_destroy_empty(self):
        """ Tests and Checks if class is missing """
        with patch('sys.stdout', new=StringIO()) as val:
    ...
    def test_destroy_id(self):
        """ tests and Check if the id is missing """
        with patch('sys.stdout', new=StringIO()) as val:
