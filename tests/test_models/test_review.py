#!/usr/bin/python3
"""
Has all the TestReviewDocs classes
"""
...
class TestReviewDocs(unittest.TestCase):
    ...
    def test_review_class_docstring(self):
        """check for the Review class docstring"""
        self.assertIsNot(Review.__doc__, None,
...
class TestReview(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """if Review is a subclass of BaseModel"""
        review = Review()
    ...
    def test_place_id_attr(self):
        """check if Review has attr place_id, and it's an empty string"""
        review = Review()
    ...
    def test_text_attr(self):
        """verify if Review has attr text, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "text"))
        self.assertEqual(review.text, "")

    def test_to_dict_creates_dict(self):
        """check to_dict method creates a dictionary with proper attrs"""
        r = Review()
        new_d = r.to_dict()
    ...
    def test_str(self):
        """check the str method has the correct output"""
        review = Review()
