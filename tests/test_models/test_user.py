#!/usr/bin/python3
"""
The Contains the TestUserDocs classes
"""
...
class TestUserDocs(unittest.TestCase):
    """Documentation and style of User class"""
    @classmethod
    def setUpClass(cls):
        """Doc tests"""
    ...
    def test_user_func_docstrings(self):
        """The presence of docstrings in User methods"""
...
class TestUser(unittest.TestCase):
    ...
    def test_last_name_attr(self):
        """User has attr last_name, and it's an empty string"""
        user = User()
    ...
    def test_to_dict_values(self):
        """The values in dict returned from to_dict are correct"""
